...
public class PolicyPurchaseTestJunitMock {
	...
	void testGetPolicyPurchase() throws PolicyPurchaseNotFoundException {
		...
		a2.setPolicy(null);;
		a2.setPolicyPuchaseDuration(2);;
		a2.setPolicyPurchaseId(2);;
		a2.setPolicyUser(null);;
		a2.setPremiumAmount(5000);;
		a2.setPurchaseDate(null);
		a2.setPurchaseEndDate(null);
