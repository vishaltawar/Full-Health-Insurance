...
public class PolicyPurchase {
	...
	public PolicyPurchase(long policyPurchaseId, double premiumAmount, int policyPuchaseDuration,
			LocalDate purchaseDate, LocalDate purchaseEndDate, Policy policy, PolicyUser policyUser) {
		super();
